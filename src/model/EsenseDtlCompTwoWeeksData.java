...
public class EsenseDtlCompTwoWeeksData extends UsageHistoryResponse{
	...
	public void fillGapIfAllDataNotAvailable(){
		...
		List<Date> currDateList = UsageHistoryUtil.getWeekDateListFromWeekNum(super.getCurrentYearWeekNum());
		List<Date> prevDateList = UsageHistoryUtil.getWeekDateListFromWeekNum(super.getPrevYearWeekNumber());
